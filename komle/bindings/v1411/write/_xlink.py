...
class typeType(
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 31, 1
    )
    _Documentation = None


typeType._CF_enumeration = pyxb.binding.facets.CF_enumeration(
    value_datatype=typeType, enum_prefix=None
)
typeType.simple = typeType._CF_enumeration.addEnumeration(
    unicode_value='simple', tag='simple'
)
typeType.extended = typeType._CF_enumeration.addEnumeration(
    unicode_value='extended', tag='extended'
)
typeType.title = typeType._CF_enumeration.addEnumeration(
    unicode_value='title', tag='title'
)
typeType.resource = typeType._CF_enumeration.addEnumeration(
    unicode_value='resource', tag='resource'
)
typeType.locator = typeType._CF_enumeration.addEnumeration(
    unicode_value='locator', tag='locator'
)
typeType.arc = typeType._CF_enumeration.addEnumeration(
    unicode_value='arc', tag='arc'
)
...
class hrefType(pyxb.binding.datatypes.anyURI):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 44, 1
    )
    _Documentation = None
...
class roleType(pyxb.binding.datatypes.anyURI):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 50, 1
    )
    _Documentation = None
...
class arcroleType(pyxb.binding.datatypes.anyURI):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 58, 1
    )
    _Documentation = None


arcroleType._CF_minLength = pyxb.binding.facets.CF_minLength(
    value=pyxb.binding.datatypes.nonNegativeInteger(1)
)
...
class titleAttrType(pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 66, 1
    )
    _Documentation = None
...
class showType(
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 72, 1
    )
    _Documentation = None


showType._CF_enumeration = pyxb.binding.facets.CF_enumeration(
    value_datatype=showType, enum_prefix=None
)
showType.new = showType._CF_enumeration.addEnumeration(
    unicode_value='new', tag='new'
)
showType.replace = showType._CF_enumeration.addEnumeration(
    unicode_value='replace', tag='replace'
)
showType.embed = showType._CF_enumeration.addEnumeration(
    unicode_value='embed', tag='embed'
)
showType.other = showType._CF_enumeration.addEnumeration(
    unicode_value='other', tag='other'
)
showType.none = showType._CF_enumeration.addEnumeration(
...
class actuateType(
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 84, 1
    )
    _Documentation = None


actuateType._CF_enumeration = pyxb.binding.facets.CF_enumeration(
    value_datatype=actuateType, enum_prefix=None
)
actuateType.onLoad = actuateType._CF_enumeration.addEnumeration(
    unicode_value='onLoad', tag='onLoad'
)
actuateType.onRequest = actuateType._CF_enumeration.addEnumeration(
    unicode_value='onRequest', tag='onRequest'
)
actuateType.other = actuateType._CF_enumeration.addEnumeration(
    unicode_value='other', tag='other'
)
actuateType.none = actuateType._CF_enumeration.addEnumeration(
    unicode_value='none', tag='none'
)
...
class labelType(pyxb.binding.datatypes.NCName):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 95, 1
    )
    _Documentation = None
...
class fromType(pyxb.binding.datatypes.NCName):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 101, 1
    )
    _Documentation = None
...
class toType(pyxb.binding.datatypes.NCName):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 107, 1
    )
    _Documentation = None
...
class simple(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 127, 1
    )
    _ElementMap = {}
    _AttributeMap = {}
    ...
    __type = pyxb.binding.content.AttributeUse(
        ...
        'type',
        '__httpwww_w3_org1999xlink_simple_httpwww_w3_org1999xlinktype',
        _module_typeBindings.typeType,
        fixed=True,
        unicode_default='simple',
    )
    __type._DeclarationLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 29, 1
    )
    __type._UseLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 112, 2
    )
    ...
    __href = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(Namespace, 'href'),
        'href',
        '__httpwww_w3_org1999xlink_simple_httpwww_w3_org1999xlinkhref',
        _module_typeBindings.hrefType,
    )
    __href._DeclarationLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 42, 1
    )
    __href._UseLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 113, 2
    )
    ...
    __role = pyxb.binding.content.AttributeUse(
        ...
        'role',
        '__httpwww_w3_org1999xlink_simple_httpwww_w3_org1999xlinkrole',
        _module_typeBindings.roleType,
    )
    __role._DeclarationLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 48, 1
    )
    __role._UseLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 114, 2
    )
    ...
    __arcrole = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(Namespace, 'arcrole'),
        'arcrole',
        '__httpwww_w3_org1999xlink_simple_httpwww_w3_org1999xlinkarcrole',
        _module_typeBindings.arcroleType,
    )
    __arcrole._DeclarationLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 56, 1
    )
    __arcrole._UseLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 115, 2
    )
    ...
    __title = pyxb.binding.content.AttributeUse(
        ...
        'title',
        '__httpwww_w3_org1999xlink_simple_httpwww_w3_org1999xlinktitle',
        _module_typeBindings.titleAttrType,
    )
    __title._DeclarationLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 64, 1
    )
    __title._UseLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 116, 2
    )
    ...
    __show = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(Namespace, 'show'),
        'show',
        '__httpwww_w3_org1999xlink_simple_httpwww_w3_org1999xlinkshow',
        _module_typeBindings.showType,
    )
    __show._DeclarationLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 70, 1
    )
    __show._UseLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 117, 2
    )
    ...
    __actuate = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(Namespace, 'actuate'),
        'actuate',
        '__httpwww_w3_org1999xlink_simple_httpwww_w3_org1999xlinkactuate',
        _module_typeBindings.actuateType,
    )
    __actuate._DeclarationLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 82, 1
    )
    __actuate._UseLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 118, 2
    )
...
class extended(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 153, 1
    )
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __title = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, 'title'),
        'title',
        '__httpwww_w3_org1999xlink_extended_httpwww_w3_org1999xlinktitle',
        True,
        pyxb.utils.utility.Location(
            'http://www.w3.org/1999/xlink.xsd', 167, 1
        ),
    )
    ...
    __resource = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, 'resource'),
        'resource',
        '__httpwww_w3_org1999xlink_extended_httpwww_w3_org1999xlinkresource',
        True,
        pyxb.utils.utility.Location(
            'http://www.w3.org/1999/xlink.xsd', 193, 1
        ),
    )
    ...
    __locator = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, 'locator'),
        'locator',
        '__httpwww_w3_org1999xlink_extended_httpwww_w3_org1999xlinklocator',
        True,
        pyxb.utils.utility.Location(
            'http://www.w3.org/1999/xlink.xsd', 213, 1
        ),
    )
    ...
    __arc = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, 'arc'),
        'arc',
        '__httpwww_w3_org1999xlink_extended_httpwww_w3_org1999xlinkarc',
        True,
        pyxb.utils.utility.Location(
            'http://www.w3.org/1999/xlink.xsd', 241, 1
        ),
    )
    ...
    __type = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(Namespace, 'type'),
        'type',
        '__httpwww_w3_org1999xlink_extended_httpwww_w3_org1999xlinktype',
        _module_typeBindings.typeType,
        fixed=True,
        unicode_default='extended',
        required=True,
    )
    __type._DeclarationLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 29, 1
    ...
    __type._UseLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 139, 2
    )
    ...
    __role = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(Namespace, 'role'),
        'role',
        '__httpwww_w3_org1999xlink_extended_httpwww_w3_org1999xlinkrole',
        _module_typeBindings.roleType,
    )
    __role._DeclarationLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 48, 1
    ...
    __role._UseLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 140, 2
    )

    role = property(__role.value, __role.set, None, None)

    # Attribute {http://www.w3.org/1999/xlink}title uses Python identifier title_
    __title_ = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(Namespace, 'title'),
        'title_',
        '__httpwww_w3_org1999xlink_extended_httpwww_w3_org1999xlinktitle_',
        _module_typeBindings.titleAttrType,
    )
    __title_._DeclarationLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 64, 1
    )
    __title_._UseLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 141, 2
    )
...
class titleEltType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 188, 1
    )
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __lang = pyxb.binding.content.AttributeUse(
        ...
        'lang',
        '__httpwww_w3_org1999xlink_titleEltType_httpwww_w3_orgXML1998namespacelang',
        pyxb.binding.xml_.STD_ANON_lang,
    )
    __lang._DeclarationLocation = None
    __lang._UseLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 171, 2
    )
    ...
    __type = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(Namespace, 'type'),
        'type',
        '__httpwww_w3_org1999xlink_titleEltType_httpwww_w3_org1999xlinktype',
        _module_typeBindings.typeType,
        fixed=True,
        unicode_default='title',
        required=True,
    )
    __type._DeclarationLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 29, 1
    ...
    __type._UseLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 170, 2
    )
    ...
    _HasWildcardElement = True
    _ElementMap.update({})
    _AttributeMap.update({__lang.name(): __lang, __type.name(): __type})
...
class resourceType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 208, 1
    )
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __type = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(Namespace, 'type'),
        'type',
        '__httpwww_w3_org1999xlink_resourceType_httpwww_w3_org1999xlinktype',
        _module_typeBindings.typeType,
        fixed=True,
        unicode_default='resource',
        required=True,
    )
    __type._DeclarationLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 29, 1
    ...
    __type._UseLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 196, 2
    )
    ...
    __role = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(Namespace, 'role'),
        'role',
        '__httpwww_w3_org1999xlink_resourceType_httpwww_w3_org1999xlinkrole',
        _module_typeBindings.roleType,
    )
    __role._DeclarationLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 48, 1
    ...
    __role._UseLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 197, 2
    )
    ...
    __title = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(Namespace, 'title'),
        'title',
        '__httpwww_w3_org1999xlink_resourceType_httpwww_w3_org1999xlinktitle',
        _module_typeBindings.titleAttrType,
    )
    __title._DeclarationLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 64, 1
    ...
    __title._UseLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 198, 2
    )

    title = property(__title.value, __title.set, None, None)

    # Attribute {http://www.w3.org/1999/xlink}label uses Python identifier label
    __label = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(Namespace, 'label'),
        'label',
        '__httpwww_w3_org1999xlink_resourceType_httpwww_w3_org1999xlinklabel',
        _module_typeBindings.labelType,
    )
    __label._DeclarationLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 93, 1
    )
    __label._UseLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 199, 2
    )
...
class locatorType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 236, 1
    )
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __title = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, 'title'),
        'title',
        '__httpwww_w3_org1999xlink_locatorType_httpwww_w3_org1999xlinktitle',
        True,
        pyxb.utils.utility.Location(
            'http://www.w3.org/1999/xlink.xsd', 167, 1
        ),
    ...
    __type = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(Namespace, 'type'),
        'type',
        '__httpwww_w3_org1999xlink_locatorType_httpwww_w3_org1999xlinktype',
        _module_typeBindings.typeType,
        fixed=True,
        unicode_default='locator',
        required=True,
    )
    __type._DeclarationLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 29, 1
    ...
    __type._UseLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 216, 2
    )
    ...
    __href = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(Namespace, 'href'),
        'href',
        '__httpwww_w3_org1999xlink_locatorType_httpwww_w3_org1999xlinkhref',
        _module_typeBindings.hrefType,
        required=True,
    )
    __href._DeclarationLocation = pyxb.utils.utility.Location(
    ...
    __href._UseLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 217, 2
    )
    ...
    __role = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(Namespace, 'role'),
        'role',
        '__httpwww_w3_org1999xlink_locatorType_httpwww_w3_org1999xlinkrole',
        _module_typeBindings.roleType,
    )
    __role._DeclarationLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 48, 1
    ...
    __role._UseLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 218, 2
    )
    ...
    __title_ = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(Namespace, 'title'),
        'title_',
        '__httpwww_w3_org1999xlink_locatorType_httpwww_w3_org1999xlinktitle_',
        _module_typeBindings.titleAttrType,
    )
    __title_._DeclarationLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 64, 1
    ...
    __title_._UseLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 219, 2
    )
    ...
    __label = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(Namespace, 'label'),
        'label',
        '__httpwww_w3_org1999xlink_locatorType_httpwww_w3_org1999xlinklabel',
        _module_typeBindings.labelType,
    )
    __label._DeclarationLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 93, 1
    ...
    __label._UseLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 220, 2
    )
...
class arcType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 265, 1
    )
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __title = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, 'title'),
        'title',
        '__httpwww_w3_org1999xlink_arcType_httpwww_w3_org1999xlinktitle',
        True,
        pyxb.utils.utility.Location(
            'http://www.w3.org/1999/xlink.xsd', 167, 1
        ),
    ...
    __type = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(Namespace, 'type'),
        'type',
        '__httpwww_w3_org1999xlink_arcType_httpwww_w3_org1999xlinktype',
        _module_typeBindings.typeType,
        fixed=True,
        unicode_default='arc',
        required=True,
    ...
    __type._UseLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 244, 2
    )
    ...
    __arcrole = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(Namespace, 'arcrole'),
        'arcrole',
        '__httpwww_w3_org1999xlink_arcType_httpwww_w3_org1999xlinkarcrole',
        _module_typeBindings.arcroleType,
    )
    __arcrole._DeclarationLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 56, 1
    ...
    __arcrole._UseLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 245, 2
    )
    ...
    __title_ = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(Namespace, 'title'),
        'title_',
        '__httpwww_w3_org1999xlink_arcType_httpwww_w3_org1999xlinktitle_',
        _module_typeBindings.titleAttrType,
    )
    __title_._DeclarationLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 64, 1
    ...
    __title_._UseLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 246, 2
    )
    ...
    __show = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(Namespace, 'show'),
        'show',
        '__httpwww_w3_org1999xlink_arcType_httpwww_w3_org1999xlinkshow',
        _module_typeBindings.showType,
    )
    __show._DeclarationLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 70, 1
    ...
    __show._UseLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 247, 2
    )
    ...
    __actuate = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(Namespace, 'actuate'),
        'actuate',
        '__httpwww_w3_org1999xlink_arcType_httpwww_w3_org1999xlinkactuate',
        _module_typeBindings.actuateType,
    )
    __actuate._DeclarationLocation = pyxb.utils.utility.Location(
        'http://www.w3.org/1999/xlink.xsd', 82, 1
...
title = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, 'title'),
    titleEltType,
...
resource = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, 'resource'),
    resourceType,
    abstract=pyxb.binding.datatypes.boolean(1),
    location=pyxb.utils.utility.Location(
...
Namespace.addCategoryObject(
    'elementBinding', resource.name().localName(), resource
)

locator = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, 'locator'),
    locatorType,
    abstract=pyxb.binding.datatypes.boolean(1),
    location=pyxb.utils.utility.Location(
...
Namespace.addCategoryObject(
    'elementBinding', locator.name().localName(), locator
)

arc = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, 'arc'),
    arcType,
    abstract=pyxb.binding.datatypes.boolean(1),
    location=pyxb.utils.utility.Location(
...
def _BuildAutomaton():
    ...
    cc_0 = fac.CounterCondition(
        ...
        metadata=pyxb.utils.utility.Location(
            'http://www.w3.org/1999/xlink.xsd', 123, 3
        ),
    )
    counters.add(cc_0)
    states = []
...
def _BuildAutomaton_():
    ...
    cc_0 = fac.CounterCondition(
        ...
        max=None,
        metadata=pyxb.utils.utility.Location(
            'http://www.w3.org/1999/xlink.xsd', 163, 2
        ),
    )
    counters.add(cc_0)
    states = []
    ...
    symbol = pyxb.binding.content.ElementUse(
        extended._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'title')),
        pyxb.utils.utility.Location(
            'http://www.w3.org/1999/xlink.xsd', 146, 4
        ),
    )
    st_0 = fac.State(
        symbol,
    ...
    symbol = pyxb.binding.content.ElementUse(
        ...
        pyxb.utils.utility.Location(
            'http://www.w3.org/1999/xlink.xsd', 147, 4
        ),
    )
    st_1 = fac.State(
        symbol,
    ...
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(
        extended._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'locator')),
        pyxb.utils.utility.Location(
            'http://www.w3.org/1999/xlink.xsd', 148, 4
        ),
    )
    st_2 = fac.State(
        symbol,
    ...
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(
        extended._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'arc')),
        pyxb.utils.utility.Location(
            'http://www.w3.org/1999/xlink.xsd', 149, 4
        ),
    )
    st_3 = fac.State(
        symbol,
...
def _BuildAutomaton_2():
    ...
    cc_0 = fac.CounterCondition(
        ...
        max=None,
        metadata=pyxb.utils.utility.Location(
            'http://www.w3.org/1999/xlink.xsd', 184, 3
        ),
    )
    counters.add(cc_0)
    states = []
...
def _BuildAutomaton_3():
    ...
    cc_0 = fac.CounterCondition(
        ...
        max=None,
        metadata=pyxb.utils.utility.Location(
            'http://www.w3.org/1999/xlink.xsd', 204, 3
        ),
    )
    counters.add(cc_0)
    states = []
...
def _BuildAutomaton_4():
    ...
    cc_0 = fac.CounterCondition(
        ...
        max=None,
        metadata=pyxb.utils.utility.Location(
            'http://www.w3.org/1999/xlink.xsd', 232, 3
        ),
    )
    counters.add(cc_0)
    states = []
...
def _BuildAutomaton_5():
    ...
    cc_0 = fac.CounterCondition(
        ...
        max=None,
        metadata=pyxb.utils.utility.Location(
            'http://www.w3.org/1999/xlink.xsd', 261, 3
        ),
    )
    counters.add(cc_0)
    states = []
    ...
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(
        arcType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'title')),
        pyxb.utils.utility.Location(
            'http://www.w3.org/1999/xlink.xsd', 261, 3
        ),
    )
